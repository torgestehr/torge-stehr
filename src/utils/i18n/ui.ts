...
export const ui = {
    en: {
        ...
        'services.software-development.title-no-break': 'Software Development',
        ...
        'services.workflow-automation.title-no-break': 'Workflow Automation',
    ...
    de: {
        ...
        'services.software-development.title-no-break': 'Software-Entwicklung',
        ...
        'services.workflow-automation.title-no-break': 'Workflow-Automatisierung',
