export const defaultLang: 'de' | 'en' = 'en';
...
export const ui = {
    en: {
        ...
        'services.it-support.text': ' I provide reliable IT support services, ensuring prompt issue resolution, proactive maintenance, and seamless system operations to minimize downtime and optimize productivity.',
    ...
    de: {
        ...
        'services.it-support.title': 'IT-Support',
        'services.it-support.text': 'Ich biete zuverlässigen IT-Support, garantiere schnelle Problemlösungen, proaktive Wartung und reibungslosen Systembetrieb, um Ausfallzeiten zu minimieren und die Produktivität zu steigern.',
